...
DropDuplicates_node1675893304757 = DynamicFrame.fromDF(
    CustomerTrusted_node1675889561279.toDF().dropDuplicates(["email"]),
    glueContext,
    "DropDuplicates_node1675893304757",
)

# Script generated for node Join Customer
JoinCustomer_node2 = Join.apply(
    frame1=AccelerometerLanding_node1,
    frame2=DropDuplicates_node1675893304757,
    keys1=["user"],
    keys2=["email"],
